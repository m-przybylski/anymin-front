...
describe('LongPollingService', () => {
  ...
  it(
    'should start polling data from observable',
    fakeAsync(
  ...
  it(
    'should retry to poll data after one interval and expect result',
    fakeAsync(
      inject([LongPollingService], (service: LongPollingService) => {
  ...
  it(
    'should retry to poll data three times and wait total of 5 seconds',
    fakeAsync(
      inject([LongPollingService], (service: LongPollingService) => {
