...
describe('Service: PinCode service', () => {
  ...
  it(
    'should redirect user to set password',
    fakeAsync(() => {
      ...
      mockRegistrationService.confirmVerificationRoute.and.returnValue(
        of({
          accountId: '12',
        }),
      );
  ...
  it(
    'should not be able to redirect user to set password and display alert to user',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
  ...
  it(
    'should display error if user try to create another token',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
  ...
  it(
    'should display error if user try to send pin code too recently',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
  ...
  it(
    'should return status incorrect verification of token',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
  ...
  it(
    'should return status can not find the token ',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
  ...
  it(
    'should return status incorrect validation',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
  ...
  it(
    'should return status too many msisdn token attempts',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
  ...
  it(
    'should display alert and return error status on unhandled backend error',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
  ...
  it(
    'should display alert and return error status on undefined errors from backend',
    fakeAsync(() => {
      const mockRegistrationService = TestBed.get(RegistrationService);
      const mockUserSessionService = TestBed.get(UserSessionService);
      const pinCodeViewService = TestBed.get(PinCodeViewService);
