...
describe('Service: PasswordService', () => {
  ...
  it(
    'should return TOO_MANY_ATTEMPTS status when user login unsuccessful too many times',
    fakeAsync(() => {
  ...
  it(
    'should return WRONG_PASSWORD status when password does not match regexp',
    fakeAsync(() => {
      const passwordService = TestBed.get(PasswordViewService);
      const userSessionService = TestBed.get(UserSessionService);
      const registrationService = TestBed.get(RegistrationInvitationService);
  ...
  it(
    'should return WRONG_PASSWORD status when password is wrong',
    fakeAsync(() => {
      const passwordService = TestBed.get(PasswordViewService);
      const userSessionService = TestBed.get(UserSessionService);
      const registrationService = TestBed.get(RegistrationInvitationService);
  ...
  it(
    'should return ERROR status when backend error is unhandled',
    fakeAsync(() => {
      const passwordService = TestBed.get(PasswordViewService);
      const userSessionService = TestBed.get(UserSessionService);
      const registrationService = TestBed.get(RegistrationInvitationService);
  ...
  it(
    'should return ERROR status when login fails',
    fakeAsync(() => {
      const passwordService = TestBed.get(PasswordViewService);
      const userSessionService = TestBed.get(UserSessionService);
      const registrationService = TestBed.get(RegistrationInvitationService);
