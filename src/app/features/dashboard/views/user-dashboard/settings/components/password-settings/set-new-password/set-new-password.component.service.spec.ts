...
describe('Service: SetNewPasswordComponentService', () => {
  ...
  it(
    'should return SUCCESS status and show success alert when set new password pass',
    fakeAsync(() => {
  ...
  it(
    'should return ERROR status and show danger alert when set password failed without backend error',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const mockAlertService = TestBed.get(AlertService);
      const setNewPasswordComponentService = TestBed.get(SetNewPasswordComponentService);
  ...
  it(
    'should return ERROR status and show danger alert when set password failed with unhandled backend error',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const mockAlertService = TestBed.get(AlertService);
      const setNewPasswordComponentService = TestBed.get(SetNewPasswordComponentService);
  ...
  it(
    'should return INVALID status alert when set password failed with IncorrectValidation backend error',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const setNewPasswordComponentService = TestBed.get(SetNewPasswordComponentService);
