...
export class ChangeMsisdnComponentService {
  private readonly verifyMsisdnStatusMap: Map<BackendErrors, VerifyMsisdnStatusEnum> = new Map<
    BackendErrors,
    VerifyMsisdnStatusEnum
  >([
  ...
  constructor(private accountService: AccountService, loggerFactory: LoggerFactory) {
