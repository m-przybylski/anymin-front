...
describe('Service: PinVerificationComponentService', () => {
      ...
      providers: [
        PinVerificationComponentService,
        {
          ...
          useValue: Deceiver(RecoverPasswordService, {
            postRecoverPasswordMsisdnVerifyRoute: jest.fn(),
  ...
  it('should return SUCCESS status when verify recover password token pass', fakeAsync(() => {
    ...
    mockRecoverPasswordService.postRecoverPasswordMsisdnVerifyRoute.mockReturnValue(of({}));
  ...
  it(
    ...
    () => {
      ...
      mockRecoverPasswordService.postRecoverPasswordMsisdnVerifyRoute.mockReturnValue(
        throwError({
          error: {
