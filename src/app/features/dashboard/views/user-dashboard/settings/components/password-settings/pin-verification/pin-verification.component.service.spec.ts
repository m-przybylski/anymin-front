...
describe('Service: PinVerificationComponentService', () => {
  ...
  it(
    'should return SUCCESS status when check pin token pass',
    fakeAsync(() => {
      ...
      pinVerificationComponentService
        .checkPinToken(mockToken, mockPhoneNumber)
  ...
  it(
    ...
    fakeAsync(() => {
      ...
      pinVerificationComponentService.checkPinToken(mockToken, mockPhoneNumber).subscribe(
        () => {},
  ...
  it(
    'should return CAN_NOT_FIND_TOKEN status when check pin token failed with backend error CannotFindMsisdnToken',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const pinVerificationComponentService = TestBed.get(PinVerificationComponentService);
  ...
  it(
    'should return TOO_MANY_ATTEMPTS status when check pin token failed with backend error TooManyMsisdnTokenAttempts',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const pinVerificationComponentService = TestBed.get(PinVerificationComponentService);
  ...
  it(
    'should return INVALID_TOKEN status when check pin token failed with backend error IncorrectValidation',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const pinVerificationComponentService = TestBed.get(PinVerificationComponentService);
  ...
  it(
    'should return ERROR status and show alert when check pin token failed with unhandled backend error',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
  ...
  it(
    'should return ERROR status and show alert when check pin token failed without backend error',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const mockAlertService = TestBed.get(AlertService);
      const pinVerificationComponentService = TestBed.get(PinVerificationComponentService);
