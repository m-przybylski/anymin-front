...
describe('Service: ChangePasswordComponentService', () => {
  ...
  it(
    'should return SUCCESS status and show success alert when change password pass',
    fakeAsync(() => {
  ...
  it(
    'should return ERROR status and show danger alert when change password failed without backend error',
    fakeAsync(() => {
      const mockAccountService = TestBed.get(AccountService);
      const mockAlertService = TestBed.get(AlertService);
      const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
  ...
  it(
    'should return WRONG_PASSWORD status when change password failed with IncorrectValidation backend error',
    fakeAsync(() => {
      const mockAccountService = TestBed.get(AccountService);
      const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
  ...
  it(
    'should return RECOVER_BY_EMAIL status when recover password method is email',
    fakeAsync(() => {
  ...
  it(
    'should return RECOVER_BY_SMS status when recover password method is sms',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
  ...
  it(
    'should return ERROR status and show danger alert when recover password method is unhandled',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
