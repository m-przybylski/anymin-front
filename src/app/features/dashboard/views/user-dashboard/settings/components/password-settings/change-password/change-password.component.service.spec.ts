...
import {
  ChangePasswordComponentService, ChangePasswordStatusEnum,
...
describe('Service: ChangePasswordComponentService', () => {
  ...
  it('should return SUCCESS status and show success alert when change password pass', fakeAsync(() => {
    ...
    changePasswordComponentService.changePassword(mockActualPassword, mockNewPassword)
  ...
  it('should return ERROR status and show danger alert when change password failed without backend error',
    fakeAsync(() => {
      ...
      mockAccountService.changePasswordRoute.and.returnValue(_throw({
        error: {
          error: {}
        }
      }));
  ...
  it('should return ERROR status and show danger alert when change password failed with' +
    'unhandled backend error', fakeAsync(() => {
    const mockAccountService = TestBed.get(AccountService);
    const mockAlertService = TestBed.get(AlertService);
    const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
  ...
  it('should return WRONG_PASSWORD status when change password failed with IncorrectValidation backend error',
    fakeAsync(() => {
      const mockAccountService = TestBed.get(AccountService);
      const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
  ...
  it('should return WRONG_PASSWORD status when change password failed with BadAuthenticationCredentials' +
  ...
  it('should return TOO_MANY_ATTEMPTS status when change password failed with ToManyIncorrectPasswordAttempts' +
    'backend error', fakeAsync(() => {
    const mockAccountService = TestBed.get(AccountService);
    const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
  ...
  it('should return RECOVER_BY_EMAIL status when recover password method is email', fakeAsync(() => {
    ...
    mockRecoverPasswordService.postRecoverPasswordRoute.and.returnValue(of({
      method: GetRecoverMethod.MethodEnum.EMAIL
    }));

    changePasswordComponentService.resetPassword(mockPhoneNumber)
      .subscribe((status: ResetPasswordStatusEnum) => {
  ...
  it('should return ERROR status and show danger alert when recover password method is unhandled',
    fakeAsync(() => {
      const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
      const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
  ...
  it('should return CREATE_PIN_CODE_TOO_RECENTLY status and show danger alert when recover password failed' +
    'with backend error CreateAnotherPinCodeTokenRecently', fakeAsync(() => {
    const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
    const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
    const alertService = TestBed.get(AlertService);

    mockRecoverPasswordService.postRecoverPasswordRoute.and.returnValue(_throw({
      error: {
  ...
  it('should return CREATE_PIN_CODE_TOO_RECENTLY status and show danger alert when recover password failed' +
    'with backend error PincodeSentTooRecently', fakeAsync(() => {
    const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
    const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
    const alertService = TestBed.get(AlertService);
  ...
  it('should return ERROR status and show danger alert when recover password failed' +
    'with unhandled backend error', fakeAsync(() => {
    const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
    const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
    const alertService = TestBed.get(AlertService);
  ...
  it('should return ERROR status and show danger alert when recover password failed' +
    'without backend error', fakeAsync(() => {
    const mockRecoverPasswordService = TestBed.get(RecoverPasswordService);
    const changePasswordComponentService = TestBed.get(ChangePasswordComponentService);
    const alertService = TestBed.get(AlertService);
