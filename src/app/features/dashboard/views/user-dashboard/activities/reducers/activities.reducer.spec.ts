...
import { ExpertActivitiesApiActions, ExpertActivitiesPageActions } from '../actions';
...
describe('activities.reducer', () => {
  ...
  describe('LoadExpertAllActivitiesSuccess', () => {
    it('should populate values', () => {
      ...
      const result = reducer(
        initialState,
        new ExpertActivitiesApiActions.LoadExpertActivitiesWithImportantSuccessAction(payload as any),
      );
  ...
  describe('LoadExpertActivitiesSuccess', () => {
    it('should add activities', () => {
      ...
      const result = reducer(
        init as any,
        new ExpertActivitiesApiActions.LoadExpertActivitiesSuccessAction(payload as any),
      );
      expect(result).toEqual({
        importantActivitiesList: [{ id: 'one' }, { id: 'two' }],
        importantActivitiesCount: 2,
  ...
  describe('ShowImportantActivities && HideImportantActivities', () => {
    ...
    it('should display full list of values', () => {
      const result = reducer(hide, new ExpertActivitiesPageActions.ShowImportantActivitiesAction());
      expect(result).toEqual(show);
    });
    it('should display only x number of values', () => {
      const result = reducer(show, new ExpertActivitiesPageActions.HideImportantActivitiesAction());
  ...
  describe('ActivityDetailsClosed', () => {
    ...
    it('should remove value from display list and provide update list for expanded view', () => {
      const result = reducer(show, new ExpertActivitiesPageActions.ActivityDetailsClosedAction({ id: 'three' } as any));
      expect(result).toEqual({
    ...
    it('should remove value from display list and provide update list for collapsed view', () => {
      const result = reducer(hide, new ExpertActivitiesPageActions.ActivityDetailsClosedAction({ id: 'three' } as any));
      expect(result).toEqual({
        importantActivitiesList: [{ id: 'one' }, { id: 'two' }, { id: 'four' }, { id: 'five' }, { id: 'six' }],
        importantActivitiesCount: 5,
        activitiesList: [{ id: 'one' }, { id: 'two' }, { id: 'three' }, { id: 'four' }, { id: 'five' }, { id: 'six' }],
  ...
  describe('LoadExpertActivitySuccess', () => {
    it('should add activity to important list, and not change activitiesList', () => {
      ...
      const result = reducer(
        state,
        new ExpertActivitiesApiActions.LoadExpertActivitySuccessAction({ id: 'three' } as any),
      );
