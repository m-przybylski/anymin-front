...
export interface IActivitesState {
  expertActivities: fromActivites.IState;
  balance: fromBalance.IState;
}

export interface IState extends fromRoot.IState {
  activities: IActivitesState;
}

// tslint:disable-next-line:no-any
export const reducers: ActionReducerMap<IActivitesState, any> = {
  expertActivities: fromActivites.reducer,
 ...
 */
export const getActivitiesState = createFeatureSelector<IState, IActivitesState>('activities');

/**
 * selectors for activieties
 */
const getActivities = createSelector(getActivitiesState, state => state.expertActivities);
