...
import {GetActivity} from "../../../../common/api/model/GetActivity"
import {GetExpertServiceTuple} from "../../../../common/api/model/GetExpertServiceTuple"
import {GetActivities} from "../../../../common/api/model/GetActivities"
...
angular.module('profitelo.controller.dashboard.client.activities', [
  ...
  .config(function ($stateProvider: ng.ui.IStateProvider) {
    $stateProvider.state('app.dashboard.client.activities', {
      url: '/activities',
      template: require('./activities.jade')(),
