...
export class InputAddItemComponent {
  ...
  @Input() public onChange?: (value: string) => void;

  @Input() public isDisabled = false;

  @Output() public onEnterClick?: EventEmitter<string> = new EventEmitter<string>();

  @Input() public isChangeOnSubmit = true;

  @Input() public isValidationVisibleOnBlur? = false;
