...
export class InputTagsComponent implements OnInit {
  ...
  @Input() public errorTrKey: string;

  @Input() public isDisabled? = false;

  @Input() public onAddTagCallback: (inputValue: string) => void;

  @Input() public currentTagsCount: number;
  ...
  public onKeyUp = (event: KeyboardEvent, input: HTMLInputElement): void => {
    if (
      ...
      event.keyCode === Config.keyboardCodes.comma ||
      event.keyCode === Config.keyboardCodes.commaASCI ||
      event.keyCode === Config.keyboardCodes.semicolon ||
      event.keyCode === Config.keyboardCodes.enter
    ) {
