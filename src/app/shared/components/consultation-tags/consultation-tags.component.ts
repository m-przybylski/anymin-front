...
export class ConsultationTagsComponent implements OnInit, OnDestroy {
  ...
  @Input() public descriptionControlName: string;

  @Input() public nameControlName: string;
  ...
  @Output() public selectedTagsEmitter$: EventEmitter<string[]> = new EventEmitter<string[]>();
