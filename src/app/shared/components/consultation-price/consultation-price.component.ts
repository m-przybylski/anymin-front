...
export class ConsultationPriceComponent implements OnInit {
  @Input() public labelWithoutCommission: string;

  @Input() public labelGross: string;

  @Input() public withoutCommissionControlName: string;

  @Input() public grossControlName: string;

  @Input() public nettControlName: string;
  ...
  @Input() public taxValue: number;

  @Input() public commission: number;
