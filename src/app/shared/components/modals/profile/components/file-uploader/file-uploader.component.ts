...
export class FileUploaderComponent implements OnInit, OnDestroy {
  @Input() public profileDocuments: ProfileDocument[] = [];

  @Input() public maxFilesCount = 1;

  @Input() public maxFileSize: number = CommonConfig.getCommonConfig().validation.profile['document-size'];

  @Input() public fileCategory: FileCategoryEnum = FileCategoryEnum.EXPERT_FILE;

  @Input() public isDisabled? = false;

  @Output() public tokensListEmitter$: EventEmitter<string[]> = new EventEmitter<string[]>();

  @Output() public isUploadingEmitter$: EventEmitter<boolean> = new EventEmitter<false>();
