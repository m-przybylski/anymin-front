...
export class ModalComponent implements OnInit, AfterViewInit, OnDestroy {
  @Input() public modalTrTitleHeader?: string;

  @Input() public isBackwardVisible?: boolean;

  @Input() public onBackwardClick?: () => void;

  @Input() public modalContainerClass?: ModalContainerWidthEnum = ModalContainerWidthEnum.MEDIUM_WIDTH;

  @Input() public isCloseButtonVisible? = true;

  @ViewChild(ModalAnimationComponentDirective) public onPendingRequest: ModalAnimationComponentDirective;

  @ViewChild(ModalAnimationComponentDirective) public onChangeModalContent: ModalAnimationComponentDirective;
