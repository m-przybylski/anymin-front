...
import { LoginConfirmEmailResolver } from '../../../../angularjs/common/resolvers/login-confirm-email/login-confirm-email.service';
...
const UserServiceFactory = ($injector: angular.auto.IInjectorService): UserService => $injector.get('userService');
