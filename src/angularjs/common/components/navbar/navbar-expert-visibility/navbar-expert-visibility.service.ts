...
export class NavbarExpertVisibilityService {
  ...
  public static $inject = ['PresenceApi', '$q', '$timeout', '$window', 'anymindWebsocket'];
  ...
  constructor(
    ...
    anymindWebsocket.expertPresence.subscribe(data => this.notifyVisibilityChange({ status: data } as any));
