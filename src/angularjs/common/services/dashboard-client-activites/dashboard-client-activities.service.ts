...
import { GetPayoutMethod } from 'profitelo-api-ng/model/models';
...
export class DashboardClientActivitiesService {
  ...
  constructor(private ViewsApi: ViewsApi, private PayoutsApi: PayoutsApi, private logger: LoggerService) {}
  ...
  public getDashboardClientActivities = (queryParams: ActivitiesQueryParams): ng.IPromise<GetClientActivities> => {
    ...
    const promise = this.ViewsApi.getDashboardActivitiesClientRoute(
      activityType,
      queryParams.getProfileId(),
      queryParams.getServiceId(),
  ...
  public getPayoutMethods = (): ng.IPromise<GetPayoutMethod> => this.PayoutsApi.getPayoutMethodsRoute();
