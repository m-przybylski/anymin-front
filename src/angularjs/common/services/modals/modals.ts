...
import expertInviteEmployeesModule from '../../components/dashboard/expert/employees/modals/invite-employees/invite-employees';
...
const modalsModule = angular
  ...
  .service('modalsService', ModalsService).name;
