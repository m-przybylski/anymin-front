...
import { IClientChargeDetailsParentControllerScope } from '../../components/dashboard/client/activities/modals/charge-details/charge-details';
...
import { IExpertInviteEmployeesControllerScope } from '../../components/dashboard/expert/employees/modals/invite-employees/invite-employees.controller';
import {
  InvitationsModalController,
...
export class ModalsService {
  ...
  public createClientSUEActivityDetailsModal = (sueId: string): IModalInstanceService => {
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/client/activities/modals/consultation-details/consultation-details.html'),
      scope: dialogScope,
    });
  };
  ...
  public createClientComplainReportModal = (): IModalInstanceService => {
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/client/activities/modals/complain-report/complain-report.html'),
      scope: dialogScope,
    });
  };
  ...
  public createClientChargeDetailsModal = (financeActivityDetails: GetClientActivity): IModalInstanceService => {
    ...
    const dialogScope: IClientChargeDetailsParentControllerScope = <IClientChargeDetailsParentControllerScope>(
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/client/activities/modals/charge-details/charge-details.html'),
      scope: dialogScope,
    });
  };

  public createBasicAccountSettingsModal = (onModalClose: (cb: () => void) => void): IModalInstanceService => {
    const dialogScope: IBasicAccountSettingsControllerParentScope = <IBasicAccountSettingsControllerParentScope>(
      this.$rootScope.$new(true)
    );
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/settings/modals/general/' +
  ...
  public createGeneralPhoneSettingsModal = (onModalClose: (cb: () => void) => void): IModalInstanceService => {
    const dialogScope: IPhoneSettingsControllerScope = <IPhoneSettingsControllerScope>this.$rootScope.$new(true);
    dialogScope.callback = onModalClose;
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/settings/modals/general/phone-settings/phone-settings.html'),
      scope: dialogScope,
    });
  };

  public createGeneralEmailSettingsModal = (onModalClose: (cb: () => void) => void): IModalInstanceService => {
    const dialogScope: IGeneralEmailSettingsControllerScope = <IGeneralEmailSettingsControllerScope>(
      this.$rootScope.$new(true)
    );
    dialogScope.callback = onModalClose;
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/settings/modals/general/email-settings/email-settings.html'),
      scope: dialogScope,
    });
  };

  public createGeneralCountrySettingsModal = (onModalClose: (cb: () => void) => void): IModalInstanceService => {
    const dialogScope: IGeneralCountrySettingsControllerScope = <IGeneralCountrySettingsControllerScope>(
      this.$rootScope.$new(true)
    );
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/settings/modals/general/country-settings/country-settings.html'),
      scope: dialogScope,
    });
  };
  ...
  public createSecurityChangePasswordSettingsModal = (): IModalInstanceService => {
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/settings/modals/security/change-password/change-password.html'),
      scope: dialogScope,
    });
  };

  public createAddPaymentMethodControllerModal = (onModalClose: () => void): IModalInstanceService => {
    const dialogScope: IAddPaymentMethodControllerScope = <IAddPaymentMethodControllerScope>this.$rootScope.$new(true);

    dialogScope.callback = onModalClose;
    return this.dialogService.openDialog({
      controllerAs: 'vm',
      controller: 'addPaymentMethodController',
      template: require('angularjs/common/components/dashboard/settings/modals/payments/add-payment-method/add-payment-method.html'),
      scope: dialogScope,
    });
  };

  public createEditCompanyInvoiceControllerModal = (onModalClose: () => void): IModalInstanceService => {
    const dialogScope: IEditCompanyInvoiceControllerScope = <IEditCompanyInvoiceControllerScope>(
      this.$rootScope.$new(true)
    );
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/settings/modals/payments/edit-company-invoice/edit-company-invoice.html'),
      scope: dialogScope,
    });
  };

  public createPayoutsMethodControllerModal = (onModalClose: () => void): IModalInstanceService => {
    const dialogScope: IPayoutsModalControllerScope = <IPayoutsModalControllerScope>this.$rootScope.$new(true);
    ...
    return this.dialogService.openDialog({
      ...
      windowClass: 'modal-open',
      template: require('angularjs/common/components/dashboard/settings/modals/payouts/payouts-methods/payouts-methods.html'),
      scope: dialogScope,
    });
  };

  public createGalleryPreviewControllerModal = (preview: string): IModalInstanceService => {
    const dialogScope: IGalleryPreviewControllerScope = <IGalleryPreviewControllerScope>this.$rootScope.$new(true);
  ...
  public createExpertSUEActivityDetailsModal = (sueId: string): IModalInstanceService => {
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/expert/activities/modals/consultation-details/consultation-details.html'),
      scope: dialogScope,
    });
  };
  ...
  public createExpertPayoutCivilModal = (sueId: string): IModalInstanceService => {
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/expert/activities/modals/payout-civil/payout-civil.html'),
      scope: dialogScope,
    });
  };
  ...
  public createExpertInviteEmployeesModal = (onModalClose: () => void): IModalInstanceService => {
    const dialogScope: IExpertInviteEmployeesControllerScope = <IExpertInviteEmployeesControllerScope>(
      this.$rootScope.$new(true)
    );
    dialogScope.onModalCloseCallback = onModalClose;
  ...
  public createInvitationsModal = (
    ...
    const dialogScope: IInvitationsModalScope = <IInvitationsModalScope>this.$rootScope.$new(true);
  ...
  public createChargeAccountModal = (
    ...
    const dialogScope: IChargeAccountScope = <IChargeAccountScope>this.$rootScope.$new(true);
  ...
  public createManageProfileEditProfileModal = (
    ...
    const dialogScope: IEditExpertProfileScope = <IEditExpertProfileScope>this.$rootScope.$new(true);
  ...
  public createConsultationModal = (): IModalInstanceService => {
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/search/modals/consultation/consultation.html'),
      scope: dialogScope,
    });
  };

  public createServiceFormModal = (
    onModalClose: () => void,
    service?: ServiceWithOwnerProfile | GetService,
  ): IModalInstanceService => {
    const dialogScope: IServiceFormModalScope = <IServiceFormModalScope>this.$rootScope.$new(true);
    dialogScope.onModalCloseCallback = onModalClose;
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/expert/manage-profile/modals/service-form-modal/service-form-modal.html'),
      scope: dialogScope,
    });
  };

  public createConfirmAlertModal = (
    translationMessage: string,
    onConfirm: () => void,
    onCancel?: () => void,
    translationConfirmButtonMessage?: string,
  ): IModalInstanceService => {
    const dialogScope: IConfirmAlertScope = <IConfirmAlertScope>this.$rootScope.$new(true);
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/controllers/confirm-alert/confirm-alert.html'),
      scope: dialogScope,
    });
  };

  public createInfoAlertModal = (translationMessage: string, onModalClose?: () => void): IModalInstanceService => {
    const dialogScope: IInfoAlertScope = <IInfoAlertScope>this.$rootScope.$new(true);
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/controllers/info-alert/info-alert.html'),
      scope: dialogScope,
    });
  };
  ...
  public createCompanyInvoiceDetailsModal = (
    ...
    const dialogScope: ICompanyInvoiceDetailsModalControllerScope = <ICompanyInvoiceDetailsModalControllerScope>(
      this.$rootScope.$new(true)
    );
    dialogScope.onModalCloseCallback = onModalClose;
    ...
    return this.dialogService.openDialog({
      ...
      template: require('angularjs/common/components/dashboard/settings/modals/' +
