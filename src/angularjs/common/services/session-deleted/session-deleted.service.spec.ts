...
describe('Unit testing: profitelo.services.sessionDeletedService >', () => {
  describe('for profitelo.services.sessionDeletedService >', () => {
    const profiteloWebsocket = jasmine.createSpyObj<ProfiteloWebsocketService>('profiteloWebsocket', [
      'onSessionDeleted',
    ]);
    ...
    beforeEach(inject(($injector: ng.auto.IInjectorService) => {
      profiteloWebsocket.onSessionDeleted.and.callFake((callback: (data: ISessionDeleted) => void) => {
