...
import { GetWizardProfile, PostService } from 'profitelo-api-ng/model/models';
...
describe('Testing Controller: ConsultationController', () => {
  ...
  const createController = (
    stateParams: IConsultationStateParams,
    wizardProfile: GetWizardProfile,
  ...
  beforeEach(() => {
    ...
    inject(
      (
        ...
        state = $state;
        stateParams = $stateParams;
        (filter = $filter), (consultationController = createController(stateParams, wizardProfile));
      },
    );
  });
