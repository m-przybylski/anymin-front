    ...
    return describe('for payuPaymentFormController component >', () => {
      ...
      beforeEach(() => {
        ...
        inject(($rootScope: IRootScopeService, $compile: ng.ICompileService,
                ...
                $window: IWindowService, _$state_: ng.ui.IStateService, _PaymentsApiMock_: IPaymentsApiMock,
                _topAlertService_: ITopAlertService, _smoothScrollingService_: ISmoothScrollingService,
                PaymentsApi: IPaymentsApi, AccountApi: IAccountApi, _AccountApiMock_: IAccountApiMock, $q: ng.IQService) => {
