describe('Unit testing: profitelo.services.recommended-profiles-service', () => {
  describe('for AppExpertProfileResolver service >', () => {
    ...
    let recommendedProfilesServices
    let url = 'awesomeURL'
    let _timeout
    ...
    angular.mock.module('profitelo.services.recommended-profiles-service')
      ...
      inject(($injector) => {
        recommendedProfilesServices = $injector.get('recommendedProfilesServices')
    ...
    it('should have getRecommendedExperts function', () => {
      expect(recommendedProfilesServices.getRecommendedExperts).toBeDefined()
      expect(recommendedProfilesServices.getRecommendedCompanies).toBeDefined()
    })
    ...
    it('should return similarExperts', () => {
      ...
      const similarExperts = recommendedProfilesServices.getRecommendedExperts(services)
      $httpBackend.flush()
    ...
    it('should return similar companies', () => {
      ...
      const similarCompanies = recommendedProfilesServices.getRecommendedCompanies(services)
      $httpBackend.flush()
