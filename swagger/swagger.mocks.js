(function(angular) {
    ...
    angular
        ...
        .run(['apiUrl', '$httpBackend', function(apiUrl, $httpBackend) {
                ...
                $httpBackend.whenPUT(apiUrl + '/recover-password').respond();
                ...
                $httpBackend.whenPOST(apiUrl + '/msisdns/msisdns/verify').respond();
                $httpBackend.whenPOST(apiUrl + '/msisdns/msisdns/verify/code').respond();
