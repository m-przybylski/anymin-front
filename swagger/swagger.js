      ...
      this.$get = ['$resource', 'apiUrl', '$resourceActionConfig', function($resource, apiUrl, $resourceActionConfig) {
        return $resource(null, null, {
          ...
          **/
          ...
          }, $resourceActionConfig('3', 'getService')),
          ...
          **/
          ...
          }, $resourceActionConfig('5', 'deleteService')),
          ...
          **/
          ...
          'postService': angular.extend({
            method: 'POST',
            url: apiUrl + '/services',
          }, $resourceActionConfig('7', 'postService')),
        });
      }];
    })
      ...
      this.$get = ['$resource', 'apiUrl', '$resourceActionConfig', function($resource, apiUrl, $resourceActionConfig) {
        return $resource(null, null, {
          ...
          **/
          ...
          'postTagSuggest': angular.extend({
            method: 'POST',
            url: apiUrl + '/tags/suggest',
          }, $resourceActionConfig('0', 'postTagSuggest')),
        });
      }];
    })
